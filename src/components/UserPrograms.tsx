      ...
      <div className="container mx-auto max-w-6xl px-4">
        ...
        <div className="bg-card/90 backdrop-blur-sm border border-border rounded-lg overflow-hidden mb-16">
          ...
          <div className="flex items-center justify-between px-5 py-3 border-b border-border bg-background/70">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-primary font-medium">Galeria de Programas</span>
            </div>
            <div className="text-sm text-muted-foreground">Planos em Destaque</div>
          </div>

          
          <div className="p-8 text-center">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              <span className="text-foreground">Planos de treinos </span>
              <span className="text-primary">Gerados por IA</span>
            </h2>

            <p className="text-lg text-muted-foreground max-w-xl mx-auto mb-10">
              Explore planos de treinos personalizados que nosso assistente de IA criou para outros usuários
            </p>
            ...
            >
              ...
              <div className="flex items-center justify-between px-4 py-2 border-b border-border bg-background/70">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-primary">USUÁRIO.{program.id}</span>
                </div>
                ...
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground flex items-center gap-2 mt-1">
                      ...
                      {program.age} anos • {program.workout_days} dias/semana
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-5 pt-2">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground mt-1">
                        Nutrição otimizada pelo sistema
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <div className="flex justify-between items-center">
                        <h3 className="font-medium text-foreground">Protocolos de Segurança da IA</h3>
                      </div>
                      <p className="text-sm text-muted-foreground mt-1">
                        Sistemas de proteção ativados
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="mt-16 text-center">
          ...
          <p className="text-muted-foreground mt-4">
            Junte-se a mais de 500 usuários com programas de treinos personalizados por IA
          </p>
        </div>
      </div>
    </div>
