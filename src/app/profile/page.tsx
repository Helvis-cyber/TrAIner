...
function validateRoutine(data: any): Routine {
  return {
    name: data.name,
    sets: data.sets,
    reps: data.reps,
    description: data.description || undefined, // Garante que `description` seja opcional
  };
}
          ...
          <div className="relative backdrop-blur-sm border border-border p-6">
            ...
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-bold tracking-tight">
                ...
                <span className="text-primary">plano de treino</span>
              </h2>
            ...
            <div className="relative backdrop-blur-sm border border-border rounded-lg p-6">
              ...
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-lg font-bold">
                  PLANO: <span className="text-primary">{currentPlan.name}</span>
                </h3>
              </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <span className="font-mono text-sm text-muted-foreground">
                        Agenda: {currentPlan.workoutPlan.schedule.join(", ")}
                      </span>
                    </div>

                    <Accordion type="multiple" className="space-y-4">
                      {currentPlan.workoutPlan.exercise.map((exerciseDay, index) => (
                        <AccordionItem
                          key={index}
                          ...
                          <AccordionTrigger className="px-4 py-3 hover:no-underline hover:bg-primary/10 font-mono">
                            <div className="flex justify-between w-full items-center">
                              ...
                              <div className="text-xs text-muted-foreground">
                                {exerciseDay.routines.length} EXERCÍCIOS
                              </div>
                            </div>
                          </AccordionTrigger>
                                  ...
                                  <div className="flex justify-between items-start mb-2">
                                    ...
                                    <div className="flex items-center gap-2">
                                      ...
                                      <div className="px-2 py-1 rounded bg-secondary/20 text-secondary text-xs font-mono">
                                        {routine.reps} REPETIÇÕES
                                      </div>
                                    </div>
                                  </div>
                                  {(routine as Routine).description && (
